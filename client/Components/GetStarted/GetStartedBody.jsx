  ...
  return (
    <div className="GetStartedBody">
      <div id="infoBox">
        ...
        <br />
        <br />
        In order get the most out of this application, make sure that you have deployed a metrics
        ...
        <br />
        <br />
        In order to display the cluster view, its also necessary to download Helm, and the Prometheus helmchart repo.
